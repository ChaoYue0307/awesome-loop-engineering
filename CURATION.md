...
This repository is intentionally selective. It should help builders understand and practice Loop Engineering for AI and coding agents, not become a general AI-agent link dump.

## Acceptance Test

A resource belongs when it passes all three checks:

1. **Scope fit**: It is about AI/coding-agent loops, or a direct foundation for designing those loops.
...
- Concrete implementation detail: commands, architecture, traces, code, prompts, state files, worktrees, checks, or failure modes.
