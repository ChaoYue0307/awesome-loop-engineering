...
Explore 931 resources without collapsing looped models, agent execution, harnesses, workflows, and production operations into one idea.

## What You Can Use

- 931 papers, official docs, tools, benchmarks, and guides linked to the original work
- 30 model-layer resources, from Universal Transformers and Huginn to Loopie, LoopCoder, and LoopWM, labeled as adjacent foundations rather than complete agent loops
