...
Explore 1001 resources without collapsing looped models, agent execution, harnesses, workflows, and production operations into one idea.

## What You Can Use

- 1001 papers, official docs, tools, benchmarks, and guides linked to the original work
- 31 model-layer resources, from Universal Transformers and Huginn to Loopie, LoopCoder, and LoopWM, labeled as adjacent foundations rather than complete agent loops
...
- Checked all 669 source links and refreshed every arXiv publication record so verified conference or journal publications take precedence over preprints.
