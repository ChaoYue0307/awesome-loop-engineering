...
PUBLICATION_OVERRIDES = {
    "https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents": {
        ...
        "publication_venue": "Anthropic Engineering",
        "publisher": "Anthropic",
        "publication_note": "Author and date read from the post's own byline and dateline on anthropic.com/engineering; kept in code because automatic resolution falls back to the domain for this host.",
    ...
    "https://www.diagrid.io/blog/checkpoints-are-not-durable-execution-why-langgraph-crewai-google-adk-and-others-fall-short-for-production-agent-workflows": {
        ...
        "publication_year": "2026",
        "publisher": "Diagrid",
        "publication_note": "Author and date read from the post's own byline on diagrid.io; kept in code because automatic resolution falls back to the domain for this host.",
        "metadata_source": "publisher-meta",
    },
    "https://zenity.io/blog/current-events/ai-agent-database-deletion-pocketos": {
        ...
        "publication_year": "2026",
        "publisher": "Zenity",
        "publication_note": "Author and date read from the post's own byline on zenity.io; kept in code because automatic resolution falls back to the domain for this host.",
        "metadata_source": "publisher-meta",
    },
