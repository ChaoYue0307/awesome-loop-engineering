...
- Social preview: 1280 x 640, exact 601-resource, 20-pattern, 20-contract, and 8-starter counts, with the model-to-operations scope line.
...
- Resource Atlas: remains idle above the fold, loads on approach or a direct resource anchor, and reports `601 of 601 resources | showing 8` on a fresh mobile load.
- Resource interactions: the Model loop-layer filter returns 29 of 601 resources (28 papers plus Awesome Loop Models), paginates eight at a time on mobile, and renders Loopie and LoopWM with their 2026 arXiv records and adjacent-scope labels.
...
- Source audit: 601 rows checked; 548 public sources reachable, 5 access-restricted, 48 repository-native, and 0 broken or unreachable as of 2026-07-20 UTC.
- Data and copy: the website, README, translations, social preview source, release copy, and Hugging Face card all report 601 resources, 20 patterns, 20 contracts, 8 runtime starters, and version 0.9.0. The dataset exposes 50 fields, including `loop_layer` and `scope_fit`.
