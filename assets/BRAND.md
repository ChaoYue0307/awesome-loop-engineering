...
`awesome-loop-engineering-logo.png` for general display, `awesome-loop-engineering-logo-192.png`
for compact profile surfaces, `apple-touch-icon.png` for saved web apps, and `favicon-32.png` for
browser tabs. The high-resolution transparent source is
`awesome-loop-engineering-logo-master.png`.
...
The layered cover, circular mark, and social preview serve different compositions and should not
