...
可直接从 1022 篇论文、官方文档、工具、benchmark 与实践指南，22 个操作模式、22 个经 schema 校验的 loop contracts 和 8 个 runtime starters（3 个可直接执行，5 个可复制改造）开始，并通过社区 gallery 和 8 种语言入口继续探索。
